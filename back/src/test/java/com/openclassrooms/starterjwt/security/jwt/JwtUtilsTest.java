  ...
  MockitoAnnotations.openMocks(this);
	  ...
	  expirationField.setAccessible(true); expirationField.set(jwtUtils, 60000); //1 minute
  }
  ...
  @Test public void testValidateJwtToken() { 
  ...
  @Test public void testValidateJwtToken_ExpiredJwtException() { 
  ...
  @Test public void testValidateJwtToken_UnsupportedJwtException() { 
  ...
  @Test public void testValidateJwtToken_IllegalArgumentException() { 
	  String emptyToken = "";
